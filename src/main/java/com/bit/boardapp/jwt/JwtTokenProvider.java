...
public class JwtTokenProvider {
    ...
    // bitcampdevops4todobootapp502magicecole을 BASE64 인코딩한 값
    // Yml0Y2FtcGRldm9wczR0b2RvYm9vdGFwcDUwMg==
    private static final String SECRET_KEY = "Yml0Y2FtcGRldm9wczR0b2RvYm9vdGFwcDUwMm1hZ2ljZWNvbGU=";

    // SECRET_KEY 를 KEY 객체로 변환
    ...
    public String create(User user) {
        ...
        // JWT Token 생성하여 리턴
        // Jwts 객체를 사용하기 때문에 JWT TOKEN의 헤더의 typ에 jwt로 입력된다.
        return Jwts.builder()
    ...
    public String validateAndGetUsername(String token) {
        /* 받아온 토크값을 파싱해서 유효성을 검사
        * 토큰에 있는 시그너처와 서버에서 가지고 있는 시그니처 값과 비교
        * 일치하면  chraims 객체를 전달
        * */
